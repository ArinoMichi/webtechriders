    ...
    switch (this.user.idRole) {
      case 2:
        this._charlasService.getCharlasTechRider(this.user.idUsuario).subscribe((techRiderResponse) => {
          ...
          this._charlasService.getCharlasEstado(2).subscribe((estadoResponse) => {
        ...
        break
      case 3:
        this._TecnologiasTechRidersService.getTecnologiasTechRidersAll(this.user.idUsuario).subscribe((response) =>{
          this.tencnologiasTechRider = response
        })
        this._charlasService.getCharlasTechRider(this.user.idUsuario).subscribe((techRiderResponse) => {
          this.charlas = techRiderResponse;
