...
export class CharlasService {
  ...
  updateObservaciones(idCharla: number, observaciones: string, token: string): Observable<any>{
    var request = "api/charlas/updateobservacionescharla/" + idCharla + "/" + observaciones
    var url = environment.urlApi + request
    var headers = new HttpHeaders()
    .set('Authorization', "bearer " + token)
    return this._http.put(url, {headers: headers})
  ...
  updateEstado(idCharla: number, idEstadoCharla: number, token: string): Observable<any>{
  ...
  updateFecha(idCharla: number, fechaCharla: Date, token: string): Observable<any>{
    var request = "api/charlas/updatefechacharla/" + idCharla + "/" + fechaCharla
    var url = environment.urlApi + request
    var headers = new HttpHeaders()
    .set('Authorization', "bearer " + token)
    return this._http.put(url, {headers: headers})
